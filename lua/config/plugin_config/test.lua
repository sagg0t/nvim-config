...
-- vim.api.nvim_set_keymap('n',  '<Leader>f', '<Plug>(ultest-run-file)', {})       -- Run all tests in a file.
-- vim.api.nvim_set_keymap('n',  '<Leader>n', '<Plug>(ultest-run-nearest)', {})    -- Run test closest to the cursor.
-- vim.api.nvim_set_keymap('n',  '', '<Plug>(ultest-summary-toggle)', default_opts) -- Toggle the summary window between open and closed
-- vim.api.nvim_set_keymap('n',  '', '<Plug>(ultest-summary-jump)', default_opts)   -- Jump to the summary window (opening if it isn't already)
-- vim.api.nvim_set_keymap('n',  '', '<Plug>(ultest-output-show)', default_opts)    -- Show error output of the nearest test. (Will jump to popup window in Vim)
...
-- vim.api.nvim_set_keymap('n',  '', '<Plug>(ultest-attach)', default_opts)         -- Attach to the nearest test's running process.
